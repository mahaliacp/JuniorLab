...
// edited    Mahalia Polk And Mirka Mandich
// date		04/26/2018
...
int encoderTest(void)
{
    ...
    printf("Initialize Motor GPIO pins... "); // testing message
	initMotor(); //From motor.c, this also initializes all GPIO pins 	
	...
	//setDutyCycle(100); //move rotor
	printf("Press ENTER key to stop motor...\n");
...
// Code by Chetan Grewal Gurjit Desi
// Doesn't stop motor!
